...
import { AllReportOnServerForSuperAdmin, oneReport, reportsForOneAdmin, reportsForOneCell, reportsForOneCellbyId, WeeklyReport } from "../controller/report.controller"

const reportRouter = Router()
reportRouter.post("/weekly-reports", checkCellUser, WeeklyReport)
reportRouter.get("/reports", checkCellUser, reportsForOneCell)
reportRouter.get("/reports/:id", reportsForOneCellbyId)
