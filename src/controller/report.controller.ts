import { AllAdminReports, AllCellReportById, AllCellReports, AllReports, GetOneSignleReport, MakeReport } from "../services/report.service";
...
export const reportsForOneCellbyId : RequestHandler = (req: Request, res: Response, next: NextFunction) => AllCellReportById(req,res,next)
